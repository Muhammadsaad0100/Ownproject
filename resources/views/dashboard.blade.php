                                ...
                                <div class="d-flex align-items-start justify-content-between ">
                                    <div class="d-flex gap-4 align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <h3 class="fs-13 fw-semibold text-truncate-1-line">Total Employees</h3>
                                    ...
                                    <div class="d-flex gap-4 align-items-center">
                                       ...
                                       <i class="feather-folder"></i>
                                        ...
                                        <div>
                                            ...
                                            <h3 class="fs-13 fw-semibold text-truncate-1-line">Total Department</h3>
                                            {{-- <h5>{{ $departments }}</h5> --}}
                                        </div>
                                    </div>
                                ...
                                <div class="d-flex align-items-start justify-content-between mb-4">
                                    <div class="d-flex gap-4 align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <h3 class="fs-13 fw-semibold text-truncate-1-line">Total Salary</h3>
                                            <h5>2</h5>
                                        </div>
                                    </div>
                                    {{-- <a href="javascript:void(0);" class="">
